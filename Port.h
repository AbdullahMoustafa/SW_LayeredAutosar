...
/*Vendor ID as Abdullah Moustafa's ID is 1000*/
 ...
 *                      DET Error Codes                                        *
 *******************************************************************************/
/* DET code to Value report Invalid Port Pin ID requested */
...
/* Type definition is Data type for the symbolic name of a port pin. */
typedef uint8 Port_PinType;

/* Type definition is Data type for the symbolic name of a port type. */
typedef uint8 Port_PortType;

/* Different port pin modes. */
typedef uint8 Port_PinModeType;

/* Possible directions of a port pin direction*/
typedef enum {
	PORT_PIN_IN,
	PORT_PIN_OUT
} Port_PinDirectionType;

/* Possible directions of a port input mode */
typedef enum {
	Disable_Pull_up,
	Enable_Pull_up
} Port_Input_Mode;
